...
//ACCESS_ID
define('OSS_ACCESS_ID', Config::get('aliyun-oss::aliyun_oss.OSS_ACCESS_ID', ''));

//ACCESS_KEY
define('OSS_ACCESS_KEY', Config::get('aliyun-oss::aliyun_oss.OSS_ACCESS_KEY', ''));
...
//语言版本设置
define('ALI_LANG', Config::get('aliyun-oss::aliyun_oss.ALI_LANG', 'zh'));
